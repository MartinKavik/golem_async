        ...
        pub mod stub_counter {
            ...
            unsafe impl _rt::WasmResource for FutureGetResult {
                ...
                unsafe fn drop(_handle: u32) {
                    ...
                    {
                        #[link(
                            wasm_import_module = "golem:component-counter-stub/stub-counter"
                        )]
                        extern "C" {
            ...
            impl ApiCounter {
                ...
                pub fn new(location: &GolemRpcUri) -> Self {
                    unsafe {
                        ...
                        extern "C" {
                            #[link_name = "[constructor]api-counter"]
                        ...
                        ApiCounter::from_handle(ret as u32)
                    }
                }
            }
            impl ApiCounter {
                ...
                pub fn blocking_add(&self, value: u64) {
                    unsafe {
                        ...
                        extern "C" {
                            #[link_name = "[method]api-counter.blocking-add"]
            ...
            impl ApiCounter {
                ...
                pub fn add(&self, value: u64) {
                    unsafe {
                        ...
                        extern "C" {
                            #[link_name = "[method]api-counter.add"]
                            fn wit_import(_: i32, _: i64);
                        }
                        #[cfg(not(target_arch = "wasm32"))]
                        fn wit_import(_: i32, _: i64) {
            ...
            impl ApiCounter {
                ...
                pub fn blocking_get(&self) -> u64 {
                    unsafe {
                        ...
                        extern "C" {
                            #[link_name = "[method]api-counter.blocking-get"]
            ...
            impl ApiCounter {
                ...
                pub fn get(&self) -> FutureGetResult {
                    unsafe {
                        ...
                        extern "C" {
                            #[link_name = "[method]api-counter.get"]
                            fn wit_import(_: i32) -> i32;
                        }
                        #[cfg(not(target_arch = "wasm32"))]
                        fn wit_import(_: i32) -> i32 {
            ...
            impl ApiCounter {
                ...
                pub fn blocking_run_all_tasks(&self) {
                    unsafe {
                        ...
                        extern "C" {
                            #[link_name = "[method]api-counter.blocking-run-all-tasks"]
                            fn wit_import(_: i32);
                        }
                        #[cfg(not(target_arch = "wasm32"))]
                        fn wit_import(_: i32) {
            ...
            impl ApiCounter {
                ...
                pub fn run_all_tasks(&self) {
                    unsafe {
                        ...
                        extern "C" {
                            #[link_name = "[method]api-counter.run-all-tasks"]
                            fn wit_import(_: i32);
                        }
                        #[cfg(not(target_arch = "wasm32"))]
                        fn wit_import(_: i32) {
            ...
            pub mod api_runtime_loop {
                ...
                macro_rules! __export_golem_component_runtime_loop_api_runtime_loop_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        ...
                        unsafe extern "C" fn export_start_loop() { $($path_to_types)*::
                        _export_start_loop_cabi::<$ty > () } };
                    };
                }
                #[doc(hidden)]
...
macro_rules! __export_runtime_loop_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::golem::component_runtime_loop::api_runtime_loop::__export_golem_component_runtime_loop_api_runtime_loop_cabi!($ty
        with_types_in $($path_to_types_root)*::
        exports::golem::component_runtime_loop::api_runtime_loop);
    };
}
#[doc(inline)]
pub(crate) use __export_runtime_loop_impl as export;
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.31.0:golem:component-runtime-loop:runtime-loop:encoded world"]
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 1972] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xb1\x0e\x01A\x02\x01\
...
ethod]api-counter.run-all-tasks\x01\x12\x03\x01)golem:component-counter-stub/stu\
b-counter\x05\x04\x01B\x02\x01@\0\x01\0\x04\0\x0astart-loop\x01\0\x04\x01-golem:\
component-runtime-loop/api-runtime-loop\x05\x05\x04\x01)golem:component-runtime-\
loop/runtime-loop\x04\0\x0b\x12\x01\0\x0cruntime-loop\x03\0\0\0G\x09producers\x01\
