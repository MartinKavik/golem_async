        ...
        pub mod stub_runtime_loop {
            ...
            unsafe impl _rt::WasmResource for ApiRuntimeLoop {
                ...
                unsafe fn drop(_handle: u32) {
                    ...
                    {
                        #[link(
                            wasm_import_module = "golem:component-runtime-loop-stub/stub-runtime-loop"
                        )]
                        extern "C" {
            ...
            impl ApiRuntimeLoop {
                ...
                pub fn new(location: &GolemRpcUri) -> Self {
                    unsafe {
                        ...
                        extern "C" {
                            #[link_name = "[constructor]api-runtime-loop"]
                        ...
                        ApiRuntimeLoop::from_handle(ret as u32)
                    }
                }
            }
            impl ApiRuntimeLoop {
                #[allow(unused_unsafe, clippy::all)]
                pub fn blocking_start_loop(&self) {
                    unsafe {
                        #[cfg(target_arch = "wasm32")]
                        #[link(
                            wasm_import_module = "golem:component-runtime-loop-stub/stub-runtime-loop"
                        ...
                        extern "C" {
                            #[link_name = "[method]api-runtime-loop.blocking-start-loop"]
                            fn wit_import(_: i32);
                        }
                        #[cfg(not(target_arch = "wasm32"))]
                        fn wit_import(_: i32) {
            ...
            impl ApiRuntimeLoop {
                ...
                pub fn start_loop(&self) {
                    unsafe {
                        ...
                        extern "C" {
                            #[link_name = "[method]api-runtime-loop.start-loop"]
                            fn wit_import(_: i32);
                        }
                        #[cfg(not(target_arch = "wasm32"))]
                        fn wit_import(_: i32) {
    ...
    pub mod golem {
        ...
        pub mod component_counter {
            ...
            pub mod api_counter {
                ...
                #[doc(hidden)]
                macro_rules! __export_golem_component_counter_api_counter_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[export_name =
                        "golem:component-counter/api-counter#add"] unsafe extern "C" fn
                        export_add(arg0 : i64,) { $($path_to_types)*::
                        _export_add_cabi::<$ty > (arg0) } #[export_name =
                        "golem:component-counter/api-counter#get"] unsafe extern "C" fn
                        export_get() -> i64 { $($path_to_types)*:: _export_get_cabi::<$ty
                        > () } #[export_name =
                        "golem:component-counter/api-counter#run-all-tasks"] unsafe
                        extern "C" fn export_run_all_tasks() { $($path_to_types)*::
                        _export_run_all_tasks_cabi::<$ty > () } };
                    };
                }
                #[doc(hidden)]
                pub(crate) use __export_golem_component_counter_api_counter_cabi;
            }
        }
    }
}
...
macro_rules! __export_counter_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::golem::component_counter::api_counter::__export_golem_component_counter_api_counter_cabi!($ty
        with_types_in $($path_to_types_root)*::
        exports::golem::component_counter::api_counter);
    };
}
#[doc(inline)]
pub(crate) use __export_counter_impl as export;
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.31.0:golem:component-counter:counter:encoded world"]
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 1707] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xad\x0c\x01A\x02\x01\
...
\0#[method]api-runtime-loop.start-loop\x01\x08\x03\x013golem:component-runtime-l\
oop-stub/stub-runtime-loop\x05\x04\x01B\x06\x01@\x01\x05valuew\x01\0\x04\0\x03ad\
d\x01\0\x01@\0\0w\x04\0\x03get\x01\x01\x01@\0\x01\0\x04\0\x0drun-all-tasks\x01\x02\
\x04\x01#golem:component-counter/api-counter\x05\x05\x04\x01\x1fgolem:component-\
counter/counter\x04\0\x0b\x0d\x01\0\x07counter\x03\0\0\0G\x09producers\x01\x0cpr\
