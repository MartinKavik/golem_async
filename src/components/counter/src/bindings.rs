...
pub mod exports {
    ...
    pub mod golem {
        #[allow(dead_code)]
        pub mod component_golem_async {
            #[allow(dead_code, clippy::all)]
            pub mod api_golem_async {
                #[used]
                #[doc(hidden)]
                #[cfg(target_arch = "wasm32")]
                static __FORCE_SECTION_REF: fn() =
                ...
                macro_rules! __export_golem_component_golem_async_api_golem_async_cabi{
                                  ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {

                                    #[export_name = "golem:component-golem-async/api-golem-async#add"]
                                    unsafe extern "C" fn export_add(arg0: i64,) {
                                      $($path_to_types)*::_export_add_cabi::<$ty>(arg0)
                                    }
                                    #[export_name = "golem:component-golem-async/api-golem-async#get"]
                                    unsafe extern "C" fn export_get() -> i64 {
                                      $($path_to_types)*::_export_get_cabi::<$ty>()
                                    }
                                    #[export_name = "golem:component-golem-async/api-golem-async#run-all-tasks"]
                ...
                #[doc(hidden)]
                pub(crate) use __export_golem_component_golem_async_api_golem_async_cabi;
            }
        }
    }
}
...
macro_rules! __export_golem_async_impl {
                          ($ty:ident) => (self::export!($ty with_types_in self););
                          ($ty:ident with_types_in $($path_to_types_root:tt)*) => (
                          $($path_to_types_root)*::exports::golem::component_golem_async::api_golem_async::__export_golem_component_golem_async_api_golem_async_cabi!($ty with_types_in $($path_to_types_root)*::exports::golem::component_golem_async::api_golem_async);
                          )
                        }
#[doc(inline)]
pub(crate) use __export_golem_async_impl as export;

#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.25.0:golem-async:encoded world"]
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 1727] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xbd\x0c\x01A\x02\x01\
...
\x04\x01+golem:component-golem-async/api-golem-async\x05\x05\x04\x01'golem:compo\
nent-golem-async/golem-async\x04\0\x0b\x11\x01\0\x0bgolem-async\x03\0\0\0G\x09pr\
